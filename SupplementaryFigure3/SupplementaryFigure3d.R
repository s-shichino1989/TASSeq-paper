...
system("wget -L -O matrix_inflection_MouseSpleen1.txt.gz
       https://tus.box.com/shared/static/48djqp27ugvj9xpys82qo1o8mu0kkc3c.gz")
system("wget -L -O matrix_inflection_MouseSpleen2.txt.gz
       https://tus.box.com/shared/static/bgvuiimlypw69h8qaqfd72p5v6jmddyq.gz")
system("wget -L -O matrix_inflection_MouseSpleen3.txt.gz
...
system("wget -L -O matrix_inflection_SpleenSmartSeq2.txt.gz
       https://tus.box.com/shared/static/i25lv5ujxk3hmp38gvdvuj3cnwe30drw.gz")
