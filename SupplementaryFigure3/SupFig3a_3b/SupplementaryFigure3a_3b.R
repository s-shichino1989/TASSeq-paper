##comparison of kidney data (Supplementary Figure 3a and 3b)
...
fnames = c("10Xv2-P4-6","10Xv2-P7-5", "Smart-seq2", "TAS-Seq")
...
ggsave(p.mito, filename="mito_TASSeq_KidneyTAS-Seq.png", units="in", dpi=300,
...
ggsave(p.mito, filename="mito_10Xv2_KidneyP4-6.png", units="in", dpi=300,
       width=5, height=3, limitsize=FALSE)
...
ggsave(p.mito, filename="mito_10Xv2_KidneyP7-5.png", units="in", dpi=300,
       width=5, height=3, limitsize=FALSE)
...
ggsave(plot_grid(p, p_legend, rel_widths = c(0.5,0.4)), filename="nReads_log_Kidney.png", units="in", dpi=300,
...
ggsave(plot_grid(p, p_legend, rel_widths = c(0.5,0.4)), filename="nFeature_kidney.png", units="in", dpi=300,
       width=4, height=3.5, limitsize=FALSE)
...
write.table(res, file="stats_nGene.txt", sep="\t", quote=F, row.names=F, col.names=T)
