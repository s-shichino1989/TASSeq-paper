...
system("wget -L -O ALLgenes_byCelltype_TAS-Seq.deep.txt
       https://tus.box.com/shared/static/yf4ou6vqfcbmo65t7ntcyujxs04ql827.txt")
system("wget -L -O ALLgenes_byCelltype_Smart-seq2.txt
       https://tus.box.com/shared/static/vmans6k929ip441dwjol9ou21431bnw4.txt")
system("wget -L -O ALLgenes_byCelltype_10Xv2-TabulaMuris.txt
       https://tus.box.com/shared/static/jslqxaef9lavlgkjpf9qdxrrf67y0bai.txt")
...
ALL_table = ALL_table[ALL_table$within_avg_exp>0.25,]
...
##percent of GC analysis
  res <- getBM(attributes = c("external_gene_name", "percentage_gene_gc_content", "transcript_length"),
               ...
               values = as.vector(rownames(TASSeq_ALL[TASSeq_ALL$diff.pct >=0.25,])),
               mart = mmu)
  ...
  res3 <- getBM(attributes = c("external_gene_name", "percentage_gene_gc_content", "transcript_length"),
               filters = "external_gene_name",
               values = as.vector(rownames(TASSeq_ALL[abs(TASSeq_ALL$diff.pct) < 0.25,])),
               mart = mmu)
