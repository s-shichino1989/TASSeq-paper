...
riboRNA.genes1 = grep(pattern = "^Rrp[[:digit:]]", x = rownames(x = raw.data.seurat), value = TRUE)
riboRNA.genes2 = grep(pattern = "^Rnr[[:digit:]]", x = rownames(x = raw.data.seurat), value = TRUE)
riboRNA.genes3 = c("Rs5-8s1", "Rnrb", "Rnrc")
riboRNA.genes3 = riboRNA.genes3[riboRNA.genes3 %in% rownames(raw.data.seurat)]
riboRNA.genes = c(riboRNA.genes, riboRNA.genes1, riboRNA.genes2, riboRNA.genes3)
