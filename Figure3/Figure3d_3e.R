##shallow sequence comparison of lung data
##Figure 3d and 3e
...
fnames=gsub(".txt.gz", "", fnames)
fnames=gsub("TASSeq_MouseLungWTA", "TAS-Seq.shallow-", fnames)
...
ggsave(plot_grid(p, p_legend, rel_widths = c(0.5,0.4)), filename="nReads_log_shallow.png", units="in", dpi=300, 
...
ggsave(plot_grid(p, p_legend, rel_widths = c(0.5,0.4)), filename="nFeature_shallow.png", units="in", dpi=300, 
       width=4, height=3.5, limitsize=FALSE)
